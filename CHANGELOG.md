...
* Added `interopUse` field to AppD application records to description of an apps use of FDC3 and enable search for apps that 'interoperate' with a selected app ([#697](https://github.com/finos/FDC3/pull/697))
