...
- Upgraded all GitHub Actions to latest major versions and pinned to commit SHAs to prevent supply-chain attacks ([#1948](https://github.com/finos/FDC3/pull/1948))
- Added StepSecurity harden-runner to all CI workflow jobs ([#1948](https://github.com/finos/FDC3/pull/1948))
