...
* Fixed the `Publish To NPM` npmjs.org job to use npm trusted publishing via GitHub Actions OIDC instead of the legacy `NPM_TOKEN` flow, avoiding npmjs permission failures for direct package publishing.
