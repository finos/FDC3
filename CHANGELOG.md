...
* Added `channelId` to `FDC3ContextClearedEvent.details`, aligning the standard API event with the existing DACP payload and using the same event shape for Desktop Agent and Channel listeners. ([#2042](https://github.com/finos/FDC3/issues/2042))
