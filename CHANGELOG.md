...
* Added a Playwright contribution check that runs all non-manual conformance tests against the FDC3 for Web reference Desktop Agent. ([#2045](https://github.com/finos/FDC3/issues/2045))
