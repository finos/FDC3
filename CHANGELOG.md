...
* Removed the deprecated App Directory `/v1` routes and their V1-only schemas from the FDC3 3.0 AppD specification. ([#2094](https://github.com/finos/FDC3/issues/2094))
