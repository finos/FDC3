...
### Added
* Added `StartPayment` intent and `fdc3.payment` context type for ISO 20022 institutional payment settlement bridging. ([#2178](https://github.com/finos/FDC3/pull/2178))
