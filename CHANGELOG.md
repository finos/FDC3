...
* Added Java language binding documentation to the API reference, including Supported Platforms and alignment with the current fdc3-java-api project. ([#1734](https://github.com/finos/FDC3/pull/1734))
