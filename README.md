...
| `packages/fdc3-agent-proxy`          | `@finos/fdc3-agent-proxy` (npm)                        | Contains a complete implementation of the FDC3 WCP.  Written in a platform-agnostic manner.                                                                                                                            | Cucumber, NYC         |
| `packages/fdc3-get-agent`            | `@finos/fdc3-get-agent` (npm)                          | Implements the `getAgent` and `fdc3Ready()` functions as well as the FDC3 UI Communications protocol to allow FDC3 to work on the web or in an electron container.                                                     | Cucumber, NYC         |
