...
- If listing your logo publicly requires legal evaluation, you can reach out **privately** to [FDC3 x](mailto:fdc3-maintainers-private@finos.org).
...
- See [LICENSE_HISTORY](LICENSE_HISTORY.md) for details of licensing for previous versions of the FDC3 Standard. 
