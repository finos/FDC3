...
!(function () {
	...
	n.register &&
		...
		(window.CustomElements.flags.register = n.register)),
		(WebComponents.flags = n);
})(),
	(function (e) {
		"use strict";
		function t(e) {
		...
		function a(e, a, s) {
			...
			var d = a || "scheme start",
				...
				_ = !1,
				g = [];
			e: for (; (e[l - 1] != p || 0 == l) && !this._isInvalid; ) {
				var b = e[l];
				switch (d) {
					case "scheme start":
						if (!b || !m.test(b)) {
					...
					case "relative slash":
						...
						"\\" == b && c("\\ is an invalid code point."),
							(d = "file" == this._scheme ? "file host" : "authority ignore slashes");
						break;
					...
					case "file host":
						if (p == b || "/" == b || "\\" == b || "?" == b || "#" == b) {
							2 != u.length || !m.test(u[0]) || (":" != u[1] && "|" != u[1])
								? 0 == u.length
									? (d = "relative path start")
									: ((this._host = o.call(this, u)), (u = ""), (d = "relative path start"))
								: (d = "relative path");
							continue;
						}
					...
					case "hostname":
						if (":" != b || _) {
							...
							"	" != b && "\n" != b && "\r" != b
								? ("[" == b ? (_ = !0) : "]" == b && (_ = !1), (u += b))
								: c("Invalid code point in host/hostname: " + b);
					...
					case "relative path":
						if (p != b && "/" != b && "\\" != b && (a || ("?" != b && "#" != b)))
							...
							var O;
							(O = f[u.toLowerCase()]) && (u = O),
								".." == u
									? (this._path.pop(), "/" != b && "\\" != b && this._path.push(""))
									: "." == u && "/" != b && "\\" != b
									? this._path.push("")
									: "." != u &&
									  ("file" == this._scheme &&
								...
								"?" == b
									? ((this._query = "?"), (d = "query"))
									: "#" == b && ((this._fragment = "#"), (d = "fragment"));
						}
						break;
					case "query":
						a || "#" != b
							? p != b && "	" != b && "\n" != b && "\r" != b && (this._query += i(b))
							: ((this._fragment = "#"), (d = "fragment"));
						break;
					case "fragment":
		...
		if (!d) {
			...
			c.prototype = {
				...
				set search(e) {
					!this._isInvalid &&
						this._isRelative &&
						((this._query = "?"), "?" == e[0] && (e = e.slice(1)), a.call(this, e, "query"));
				},
				get hash() {
	...
	(function () {
		...
		if (n) {
			...
			var d = document.head;
			d.insertBefore(c, d.firstElementChild),
				(i.prototype = Object.create(HTMLElement.prototype)),
				(i.decorate = function (e) {
					if (!e.content) {
				...
				(i.bootstrap = function (e) {
					for (var t, n = e.querySelectorAll(r), o = 0, a = n.length; a > o && (t = n[o]); o++) i.decorate(t);
				}),
		...
		if (n || o) {
			...
			(i.cloneNode = function (e, t) {
				...
				return (
					...
					t && (n.content.appendChild(h.call(e.content, !0)), this.fixClonedDom(n.content, e.content)),
					n
				);
			}),
	...
	(function (e) {
		...
		if (
			((!window.CustomEvent || (r && "function" != typeof window.CustomEvent)) &&
	...
	(function (e) {
		...
		function s(e) {
			for (var t, n = 0, o = e.length; o > n && (t = e[n]); n++) c(t) && d(t);
		}
		function c(e) {
		...
		u &&
			(new MutationObserver(function (e) {
				for (var t, n = 0, o = e.length; o > n && (t = e[n]); n++) t.addedNodes && s(t.addedNodes);
	...
	window.HTMLImports.addModule(function (e) {
		...
		(o.prototype = {
			addNodes: function (e) {
				...
				for (var t, n = 0, o = e.length; o > n && (t = e[n]); n++) this.require(t);
				this.checkDone();
			},
			addNode: function (e) {
			...
			h = {
				...
				markParsingComplete: function (e) {
					(e.__importParsed = !0),
						...
						e.__importElement &&
							((e.__importElement.__importParsed = !0), this.markDynamicParsingComplete(e.__importElement)),
				...
				parseImport: function (e) {
					if (
						...
						for (var t; e.__pending.length; ) (t = e.__pending.shift()), t && t({ target: e });
					this.parseNext();
				},
				...
				trackElement: function (e, t) {
					...
					if ((e.addEventListener("load", o), e.addEventListener("error", o), d && "style" === e.localName)) {
						var r = !1;
						if (-1 == e.textContent.indexOf("@import")) r = !0;
						else if (e.sheet) {
							r = !0;
				...
				parseScript: function (t) {
					...
					(o.__importElement = t),
						(o.src = t.src ? t.src : n(t)),
						(e.currentScript = t),
						this.trackElement(o, function (t) {
				...
				nextToParseInDoc: function (e, n) {
					if (e && this._mayParse.indexOf(e) < 0) {
						...
						for (
							var o, r = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = r.length;
							a > i && (o = r[i]);
							i++
						)
							if (!this.isParsed(o))
			...
			h = {
				...
				loaded: function (e, n, o, a, s) {
					if ((i.load && console.log("loaded", e, n), (n.__resource = o), (n.__error = a), t(n))) {
						...
						void 0 === c &&
							((c = a ? null : r(o, s || e)),
							c && ((c.__importLink = n), this.bootDocument(c)),
							(this.documents[e] = c)),
							(n.__doc = c);
					}
					u.parseNext();
			...
			o = {
				added: function (e) {
					for (var o, r, i, a, s = 0, c = e.length; c > s && (a = e[s]); s++)
						o || ((o = a.ownerDocument), (r = t.isParsed(o))),
							(i = this.shouldLoadNode(a)),
							i && n.loadNode(a),
							this.shouldParseNode(a) && r && t.parseDynamic(a, i);
				},
	...
	(function (e) {
		...
		if (!e.useNative) {
			...
			"complete" === document.readyState || ("interactive" === document.readyState && !window.attachEvent)
				? t()
	...
	window.CustomElements.addModule(function (e) {
		...
		function i() {
			E = !1;
			for (var e, t = L, n = 0, o = t.length; o > n && (e = t[n]); n++) e();
			L = [];
		}
		function a(e) {
			y
	...
	window.CustomElements.addModule(function (e) {
		function t(t, o) {
			...
			return (
				c.prototype || (c.prototype = Object.create(HTMLElement.prototype)),
				(c.__name = t.toLowerCase()),
				c["extends"] && (c["extends"] = c["extends"].toLowerCase()),
				(c.lifecycle = c.lifecycle || {}),
				(c.ancestry = i(c["extends"])),
				a(c),
				s(c),
				n(c.prototype),
				l(c.__name, c),
				(c.ctor = u(c)),
				(c.ctor.prototype = c.prototype),
				(c.prototype.constructor = c.ctor),
				e.ready && v(document),
				c.ctor
			);
		}
		...
		function r(e) {
			for (var t = 0; t < y.length; t++) if (e === y[t]) return !0;
		}
		function i(e) {
			var t = d(e);
		...
		(m =
			...
			p(Node.prototype, "cloneNode"),
			p(document, "importNode"),
			(document.registerElement = t),
			(document.createElement = f),
			(document.createElementNS = h),
			(e.registry = E),
			(e["instanceof"] = m),
			(e.reservedTagList = y),
			(e.getRegisteredDefinition = d),
