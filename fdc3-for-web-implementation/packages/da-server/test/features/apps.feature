Feature: Opening and Requesting App Details
  ...
  Scenario: Opening An App
    ...
    And "storageApp/uuid5" sends validate
    Then messaging will have outgoing posts
      ...
      | WCP5ValidateAppIdentityResponse | {null}                          | {null}                               | storageApp        | uuid5                  | uuid5         | storageApp |
  ...
  #     | WCP5ValidateAppIdentityResponse | {null}                | {null}                   | uuid5         |
  ...
  #     | WCP5ValidateAppIdentityResponse | {null}                            | {null}                                   | {null}                                   | {null}        | storageApp        |
  #     | WCP5ValidateAppIdentityResponse | {null}                            | {null}                                   | {null}                                   | {null}        | storageApp        |
  #     | findInstancesResponse           |                                 2 | a1                                       | b1                                       | li            | {null}            |
