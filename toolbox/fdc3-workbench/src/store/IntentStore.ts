...
import { Channel, IntentHandler, IntentResult, Listener } from '@finos/fdc3';
...
class IntentStore {
  ...
  async addIntentListener(
    ...
    try {
      ...
      const handler: IntentHandler = async (context: ContextType, metaData?: any): Promise<IntentResult> => {
