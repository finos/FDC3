import { BasicDirectory } from '@robmoffat/fdc3-web-impl/src/directory/BasicDirectory';
import { DirectoryApp } from '@robmoffat/fdc3-web-impl/src/directory/DirectoryInterface';
