...
export interface Application {
   ...
   */
  icons?: Array<any[] | boolean | IconClass | number | number | null | string>;
  interop?: Interop;
  /**
   ...
   */
  screenshots?: Array<any[] | boolean | ScreenshotClass | number | number | null | string>;
  /**
  ...
  Application: o(
    [
      ...
      { json: 'publisher', js: 'publisher', typ: u(undefined, '') },
      {
        json: 'screenshots',
        js: 'screenshots',
        typ: u(undefined, a(u(a('any'), true, r('ScreenshotClass'), 3.14, 0, null, ''))),
      },
