...
var DefaultAppSupport = /** @class */ (function () {
    function DefaultAppSupport(messaging, appIdentifier) {
        this.thisAppMetadata = null;
    ...
    DefaultAppSupport.prototype.getAppMetadata = function (app) {
        var request = {
        ...
        return this.messaging.exchange(request, "getAppMetadataResponse").then(function (d) {
    ...
    DefaultAppSupport.prototype.getThisAppMetadata = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!this.thisAppMetadata) return [3 /*break*/, 2];
                        _a = this;
                        return [4 /*yield*/, this.getAppMetadata(this.appIdentifier)];
                    case 1:
                        _a.thisAppMetadata = _b.sent();
                        _b.label = 2;
                    case 2: return [2 /*return*/, this.thisAppMetadata];
                }
            });
        });
    };
