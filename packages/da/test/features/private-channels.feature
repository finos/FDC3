...
Background: Desktop Agent API
    ...
    Scenario: Adding a Listener on a given Private Channel to receive a notification
    ...
    #     Given "instrumentMessageOne" is a "fdc3.instrument" broadcastRequest message on channel "{privateChannel.id}"
