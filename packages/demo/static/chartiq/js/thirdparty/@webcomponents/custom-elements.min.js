		...
		function c(a) {
			return function (d) {
				...
				for (var f = [], n = 0; n < e.length; n++) {
					...
					if (r instanceof DocumentFragment) for (r = r.firstChild; r; r = r.nextSibling) c.push(r);
					else c.push(r);
				}
				a.apply(this, e);
		...
		function a(a) {
			return function (e) {
				...
				for (var k = [], h = 0; h < c.length; h++) {
					...
					if (n instanceof DocumentFragment) for (n = n.firstChild; n; n = n.nextSibling) d.push(n);
					else d.push(n);
				}
				a.apply(this, c);
	...
	function Aa() {
		...
		function d(a, b) {
			...
			t(a, "insertAdjacentHTML", function (a, c) {
				...
				} else if ("afterbegin" === a) (e = this.firstChild), b.call(this, a, c), d(this.firstChild, e);
				else if ("beforeend" === a) (e = this.lastChild), b.call(this, a, c), d(e || this.firstChild, null);
				else if ("afterend" === a) (e = this.nextSibling), b.call(this, a, c), d(this.nextSibling, e);
				else
