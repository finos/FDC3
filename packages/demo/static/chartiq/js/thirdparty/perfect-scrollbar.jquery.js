			...
			function (require, module, exports) {
				...
				function bindClickRailHandler(element, i) {
					...
					i.event.bind(i.scrollbarYRail, "click", function (e) {
						...
						var positionTop =
							i.railYRatio * (e.pageY - window.pageYOffset - pageOffset(i.scrollbarYRail).top - halfOfScrollbarLength);
					...
					i.event.bind(i.scrollbarXRail, "click", function (e) {
						...
						var positionLeft =
							i.railXRatio * (e.pageX - window.pageXOffset - pageOffset(i.scrollbarXRail).left - halfOfScrollbarLength);
						...
						updateScroll(
							element,
							"left",
							(i.contentWidth - i.containerWidth) * positionRatio - i.negativeScrollAdjustment
						);
						updateGeometry(element);
		...
		18: [
			function (require, module, exports) {
				...
				function Instance(element) {
					...
					i.railXMarginWidth =
						_.toInt(dom.css(i.scrollbarXRail, "marginLeft")) + _.toInt(dom.css(i.scrollbarXRail, "marginRight"));
					...
					i.railYMarginHeight =
						_.toInt(dom.css(i.scrollbarYRail, "marginTop")) + _.toInt(dom.css(i.scrollbarYRail, "marginBottom"));
