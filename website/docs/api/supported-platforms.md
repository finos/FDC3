...
[`@experimental`](../../fdc3-compliance#experimental-features) Introduced in FDC3 3.0 and may be refined by further changes outside the normal FDC3 versioning policy.
...
- In order to create [additional contexts](../context/spec#standard-context-types), please use the provided type [Context](../api/ref/Types#context) as a field in the custom contexts. This way the base fields ("type", "name", "id") will be embedded in the resulting json:
