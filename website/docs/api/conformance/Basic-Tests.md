...
- `BasicGI2` ![2.0+](https://img.shields.io/badge/FDC3-2.0+-blue): An `ImplementationMetadata.optionalFeatures` object can be retrieved with boolean values for each optional feature exposed by the Desktop Agent, by calling:
  - `await fdc3.getInfo()`.
