...
- `2.2-RaiseIntentContextResultMetadata`: Perform the above test.
...
- `2.2-RaiseIntentContextWithMetadataResult`: Perform the above test.
...
- `2.2-RaiseIntentChannelResultMetadata`: Perform the above test with a Channel result.
- `2.2-RaiseIntentVoidResultMetadata`: Perform the above test with a void result.
