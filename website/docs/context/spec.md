...
| JSON Schema Type | TypeScript/JavaScript | .NET | Go |
|---|---|---|---|
| `string` (ISO 8601 date-time) | `string` | `string` | `string` |
| `string` | `string` | `string` | `string` |
| `number` | `number` | `double` | `float64` |
| `integer` | `number` | `int` | `int` |
| `boolean` | `boolean` | `bool` | `bool` |
| `object` (map) | `Record<string, T>` | `IDictionary<string, T>` | `map[string]T` |
| `array` | `Array<T>` | `IEnumerable<T>` | `[]T` |
