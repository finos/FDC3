...
<https://fdc3.finos.org/schemas/next/context/product.schema.json> ([github](https://github.com/finos/FDC3/tree/main/packages/fdc3-context/schemas/context/product.schema.json))
