...
Desktop Agent bridging message exchange for the addition of an event handler to a [`PrivateChannel`](../../api/ref/PrivateChannel). Generated by API call:

- [`PrivateChannel.addEventListener(type: PrivateChannelEventTypes | null, handler: EventHandler): Promise<Listener>`](../../api/ref/PrivateChannel#addeventlistener)
...
sequenceDiagram
    ...
    AA --) DA: privateChannel.addEventListener(type, handler)
