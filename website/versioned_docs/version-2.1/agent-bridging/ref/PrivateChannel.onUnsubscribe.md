...
- [https://fdc3.finos.org/schemas/2.1/bridging/privateChannelOnUnsubscribeAgentRequest.schema.json](/schemas/2.1/bridging/privateChannelOnUnsubscribeAgentRequest.schema.json)
- [https://fdc3.finos.org/schemas/2.1/bridging/privateChannelOnUnsubscribeBridgeRequest.schema.json](/schemas/2.1/bridging/privateChannelOnUnsubscribeBridgeRequest.schema.json)
