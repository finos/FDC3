...
export default [
  ...
  },
  {
    ...
    component: ComponentCreator('/__docusaurus/debug/config', 'd2c'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/content',
    component: ComponentCreator('/__docusaurus/debug/content', '0d5'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/globalData',
    component: ComponentCreator('/__docusaurus/debug/globalData', '267'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/metadata',
    component: ComponentCreator('/__docusaurus/debug/metadata', '7ae'),
    exact: true
  },
  {
    path: '/__docusaurus/debug/registry',
    component: ComponentCreator('/__docusaurus/debug/registry', '820'),
    exact: true
  },
  {
  ...
  {
    path: '/blog',
    component: ComponentCreator('/blog', '724'),
    exact: true
  },
  {
    path: '/blog/2017/09/25/testing-rss',
    component: ComponentCreator('/blog/2017/09/25/testing-rss', 'bae'),
    exact: true
  },
  {
    path: '/blog/2017/09/26/adding-rss',
    component: ComponentCreator('/blog/2017/09/26/adding-rss', '78b'),
    exact: true
  },
  {
    path: '/blog/archive',
    component: ComponentCreator('/blog/archive', '713'),
    exact: true
  },
  {
    path: '/community',
    component: ComponentCreator('/community', 'c6e'),
    exact: true
  },
  {
    path: '/fdc3-roadmap',
    component: ComponentCreator('/fdc3-roadmap', 'c98'),
    exact: true
  },
  {
    path: '/get-involved',
    component: ComponentCreator('/get-involved', '26c'),
    exact: true
  },
  {
    path: '/users',
    component: ComponentCreator('/users', '9f8'),
    exact: true
  },
  {
    path: '/versions',
    component: ComponentCreator('/versions', 'fc6'),
    exact: true
  },
  {
    path: '/docs/1.0',
    component: ComponentCreator('/docs/1.0', '6d2'),
    routes: [
      {
  ...
  {
    path: '/docs/1.1',
    component: ComponentCreator('/docs/1.1', 'a28'),
    routes: [
      {
  ...
  {
    path: '/docs/1.2',
    component: ComponentCreator('/docs/1.2', 'a84'),
    routes: [
      {
  ...
  {
    path: '/docs/next',
    component: ComponentCreator('/docs/next', '4da'),
    routes: [
      {
  ...
  {
    path: '/',
    component: ComponentCreator('/', '597'),
    exact: true
  },
  {
    path: '*',
